...
<head>
    ...
    <style>
        ...
        .type { font-size: {{ $dimensions['font_type'] }}pt; font-weight: bold; letter-spacing: 0.5pt; text-transform: uppercase; color: #64748b; }
        .name { font-size: {{ $dimensions['font_name'] }}pt; font-weight: 600; color: #1e293b; margin: 0.5mm 0; }
