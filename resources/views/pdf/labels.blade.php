...
<head>
    ...
    <style>
        ...
        .label .type { font-size: 8pt; font-weight: bold; letter-spacing: 0.5pt; text-transform: uppercase; color: #1e293b; }
        .label .code { font-size: 12pt; font-weight: bold; margin: 1.5mm 0; color: #0f172a; }
        .label .qr { width: 28mm; height: 28mm; margin: 1mm auto; }
        .label .serial { font-size: 7pt; color: #334155; margin-top: 1mm; }
        .label .company { font-size: 7.5pt; font-weight: bold; color: #1e3a5f; margin-top: 0.5mm; }
    </style>
</head>
<body>
    <table class="grid">
